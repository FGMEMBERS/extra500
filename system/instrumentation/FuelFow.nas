...
var FuelFlow = {
	...
	applyVoltage : func(electron,name=""){ 
		Part.etd.in("FuelFlow",me.name,name,electron);
		var GND = 0;
		...
		Part.etd.out("FuelFlow",me.name,name,electron);
		return GND;
	},
	plugElectric : func(){
...
var fuelFlow = FuelFlow.new(props.globals.initNode("extra500/instrumentation/FuelFlow"),"FuelFlow");
