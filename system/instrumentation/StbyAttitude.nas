...
var StbyAttitude = {
	...
	applyVoltage : func(electron,name=""){ 
		Part.etd.in("StbyAttitude",me.name,name,electron);
		var GND = 0;
		...
		Part.etd.out("StbyAttitude",me.name,name,electron);
		return GND;
	},
	plugElectric : func(){
...
var stbyAttitude = StbyAttitude.new(props.globals.initNode("extra500/instrumentation/StbyAttitude"),"StbyAttitude");
