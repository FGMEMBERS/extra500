...
var StbyAltimeter = {
	...
	applyVoltage : func(electron,name=""){ 
		Part.etd.in("StbyAltimeter",me.name,name,electron);
		var GND = 0;
		...
		Part.etd.out("StbyAltimeter",me.name,name,electron);
		return GND;
	},
	plugElectric : func(){
...
var stbyAltimeter = StbyAltimeter.new(props.globals.initNode("extra500/instrumentation/StbyAltimeter"),"StbyAltimeter");
