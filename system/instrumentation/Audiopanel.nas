...
var AudioPanel = {
	...
	applyVoltage : func(electron,name=""){ 
		Part.etd.in("AudioPanel",me.name,name,electron);
		var GND = 0;
		...
		Part.etd.out("AudioPanel",me.name,name,electron);
		return GND;
	},
	plugElectric : func(){
...
var audioPanel = AudioPanel.new(props.globals.initNode("extra500/instrumentation/AudioPanel"),"AudioPanel");
