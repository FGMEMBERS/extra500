...
#		me.Starter 	= me.nStarter.getValue();
		...
		me.Motoring = me.nMotoring.getValue();		
		me.Spoolup = me.nSpoolup.getValue();		
		me.Spooldown = me.nSpooldown.getValue();
...
#		setprop("/fdm/jsbsim/aircraft/engine/OT-true-degC",OAT); 		
